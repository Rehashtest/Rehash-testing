...
TestData testData1 = TestDataFactory.findTestData('Data Files/Client data')

int totalRows = testData1.getRowNumbers()

for (int row = 1; row <= totalRows; row++) {
	
	String passWord = testData1.getValue('Password', row)
	String userName = testData1.getValue('Username', row)
	...
	TestData testData2 = TestDataFactory.findTestData('Data Files/APX I-REC Data IREC First')
	
	int totalRows2 = testData2.getRowNumbers()
	
	for (int rowb = 1; rowb <= totalRows2; rowb++) {
	
		String Registry = testData2.getValue('Registry', rowb)
		String Name = testData2.getValue('Device Name', rowb)
		String Capacity = testData2.getValue('Nameplate capacity', rowb)
		String primaryFuel = testData2.getValue('Fuel Type', rowb)
		String deviceTech = testData2.getValue('Device Technology', rowb)
		String commsDate = testData2.getValue('Commission date', rowb)
		String effectiveDate = testData2.getValue('Effective Registration Date', rowb)
		String Address = testData2.getValue('Address', rowb)
		String State = testData2.getValue('Province', rowb)
		String Country = testData2.getValue('Country', rowb)
		String postalCode = testData2.getValue('Postal Code', rowb)
